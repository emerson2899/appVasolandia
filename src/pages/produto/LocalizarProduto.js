...
const ProdutoBuscarScreen = () => {
  ...
  // URL base da API
  const API_URL = 'http://192.168.1.13:3000/api/produto/seguro/buscar/nome';
  ...
  const renderProdutoItem = ({ item }) => (
    <View style={styles.produtoCard}>
      ...
      <View style={styles.estoqueContainer}>
        ...
        <View style={styles.estoqueItem}>
          <Icon name="inventory-2" size={14} color="#34C759" />
          <Text style={styles.estoqueLabel}>Disponível:</Text>
          <Text style={styles.estoqueValue}>{item.estoqueDisponivel || 0}</Text>
        </View>
      </View>
      ...
      <View style={styles.adicionaisContainer}>
        {(item.peso > 0 || item.volume > 0) && (
          <View style={styles.adicionaisRow}>
            {item.peso > 0 && (
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Encontre produtos pelo nome</Text>
        </View>
...
export default ProdutoBuscarScreen;